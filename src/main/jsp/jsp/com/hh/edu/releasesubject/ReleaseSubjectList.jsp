...
<script type="text/javascript">
	function doDelete() {
		$.hh.pagelist.deleteData({
			pageid : 'pagelist',
			action : 'edu-ReleaseSubject-deleteByIds'
		});
	}
	function doAdd() {
		Dialog.open({
			url : 'jsp-edu-releasesubject-ReleaseSubjectEdit',
			params : {
				callback : function() {
					$("#pagelist").loadData();
				}
...
<body>
	<div xtype="toolbar" config="type:'head'">
		...
		<!--  <span
			...
			xtype="button"
			config="onClick: $.hh.pagelist.doUp , params:{ pageid :'pagelist',action:'edu-ReleaseSubject-order'}  ,  icon : 'hh_up' "></span>
		<span xtype="button"
			config="onClick: $.hh.pagelist.doDown , params:{ pageid :'pagelist',action:'edu-ReleaseSubject-order'} , icon : 'hh_down' "></span>
	</div>
	...
	<div id="pagelist" xtype="pagelist"
		config=" url: 'edu-ReleaseSubject-queryPagingData' ,column : [
