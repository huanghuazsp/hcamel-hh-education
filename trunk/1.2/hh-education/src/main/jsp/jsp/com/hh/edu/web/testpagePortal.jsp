			...
			<div class="portlet-content">
				<ul id="newlist">
					...
					%>
						...
						class="tab_title"  href="javascript:Request.openwin('jsp-edu-testpaper-preview?id=<%=eduTestPaper.getId()%>');"><%=eduTestPaper.getText() %></a><span><%=DateFormat.dateToStr(eduTestPaper.getDcreate(), "yyyy-MM-dd") %></span></li>
					<%}%>
				</ul>
			</div>
		</div>
